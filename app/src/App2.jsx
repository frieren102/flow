          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                {/* Flow Analysis Entry */}
                <div className="flex-1 bg-gradient-to-br from-indigo-900 to-slate-900 rounded-xl p-5 border border-indigo-500/30 relative overflow-hidden group cursor-pointer hover:shadow-lg hover:shadow-indigo-500/10 transition-all" onClick={() => setActiveTab('analysis')}>
                  <div className="absolute right-0 top-0 p-3 opacity-20 group-hover:opacity-40 transition-opacity"><Activity size={50} /></div>
                  <div className="relative z-10">
                    <h3 className="text-white font-bold text-base flex items-center gap-2">
                      <Activity size={16} className="text-indigo-400"/> Detection Analysis
                    </h3>
                    <p className="text-xs text-indigo-200 mt-1 mb-3">Inference & thresholds.</p>
                    <div className="flex items-center text-xs font-semibold text-indigo-300 group-hover:text-white transition-colors">
                      View Engine <ChevronRight size={12} className="ml-1"/>
                    </div>
                  </div>
                </div>

                {/* Amplification Entry (NEW) */}
